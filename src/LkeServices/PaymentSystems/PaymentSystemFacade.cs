...
namespace LkeServices.PaymentSystems
{
    public class PaymentSystemFacade : IPaymentSystemFacade
    {
            ...
            OwnerType owner)
        {
            ...
            return IsPaymnetSystemSupported(selection.PaymentSystem, assetId);
        }
            ...
            string otherInfoJson)
        {
            ...
            if (!IsPaymnetSystemSupported(selection.PaymentSystem, assetId))
        ...
        private bool IsPaymnetSystemSupported(CashInPaymentSystem paymentSystem, string assetId)
        {
