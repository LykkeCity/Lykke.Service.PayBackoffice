...
namespace LkeServices.Generated.MarginApi.Models
{
    ...
    public partial class OrderFullContract
    {
        ...
        public OrderFullContract(int assetAccuracy, double quoteRate, OrderFillTypeContract fillType, double interestRateSwap, double marginInit, double marginMaintenance, double openCrossPrice, double closeCrossPrice, OrderDirectionContract type, OrderStatusContract status, OrderCloseReasonContract closeReason, OrderRejectReasonContract rejectReason, double openPrice, double closePrice, System.DateTime createDate, double volume, double matchedVolume, double matchedCloseVolume, double fpl, double pnL, double commissionLot, double openCommission, double closeCommission, double swapCommission, string tradingConditionId = default(string), System.DateTime? startClosingDate = default(System.DateTime?), string comment = default(string), string id = default(string), string clientId = default(string), string accountId = default(string), string accountAssetId = default(string), string instrument = default(string), string rejectReasonText = default(string), double? expectedOpenPrice = default(double?), System.DateTime? openDate = default(System.DateTime?), System.DateTime? closeDate = default(System.DateTime?), double? takeProfit = default(double?), double? stopLoss = default(double?), IList<MatchedOrderBackendContract> matchedOrders = default(IList<MatchedOrderBackendContract>), IList<MatchedOrderBackendContract> matchedCloseOrders = default(IList<MatchedOrderBackendContract>))
        {
