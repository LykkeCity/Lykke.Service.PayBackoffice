...
namespace LkeServices.Generated.MarginApi.Models
{
    ...
    public partial class AssetPair
    {
        ...
        /// Initializes a new instance of the AssetPair class.
        /// </summary>
        public AssetPair(int accuracy, string id = default(string), string name = default(string), string baseAssetId = default(string), string quoteAssetId = default(string))
        {
            Id = id;
            Name = name;
