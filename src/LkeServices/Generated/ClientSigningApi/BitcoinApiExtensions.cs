...
namespace LkeServices.Generated.ClientSigningApi
{
   ...
   using Models;
    ...
    public static partial class BitcoinApiExtensions
    {
            ...
            /// The operations group for this extension method.
            /// </param>
            public static IsAliveResponse ApiIsAliveGet(this IBitcoinApi operations)
            {
                return System.Threading.Tasks.Task.Factory.StartNew(s => ((IBitcoinApi)s).ApiIsAliveGetAsync(), operations, System.Threading.CancellationToken.None, System.Threading.Tasks.TaskCreationOptions.None, System.Threading.Tasks.TaskScheduler.Default).Unwrap().GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async System.Threading.Tasks.Task<IsAliveResponse> ApiIsAliveGetAsync(this IBitcoinApi operations, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
            {
