...
namespace Core.MarginTrading.Payments
{
    ...
    public interface IMarginTradingPaymentLogRepository
    {
        ...
        Task<System.Collections.Generic.IEnumerable<IMarginTradingPaymentLog>> GetByClientAndAccountAsync(string clientId, string accountId, DateTime? dateFrom, DateTime? dateTo);
        Task<System.Collections.Generic.IEnumerable<IMarginTradingPaymentLog>> GetByDate(DateTime? dateFrom, DateTime? dateTo);
    }
}
