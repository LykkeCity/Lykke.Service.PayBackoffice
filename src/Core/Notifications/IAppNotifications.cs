...
using Core.Exchange;
using Core.Offchain;
using OrderStatus = Core.MarginTrading.OrderStatus;
...
namespace Core.Notifications
{
    ...
    public interface IAppNotifications
    {
        ...
        Task SendLimitOrderNotification(string[] notificationsIds, string message, OrderType orderType, string status);
